...
public interface StockyardRepository extends CrudRepository<Stockyard, Long> {
     ...
     * (Intern, Extern, Verladung) - nur im gültigen Koordinatenbereich (1-17, 1-10)
     */
    @Query("SELECT * FROM MD_STOCKYARD WHERE YARD_TYPE IN ('I', 'E', 'L') AND X_COORDINATE BETWEEN 1 AND 17 AND Y_COORDINATE BETWEEN 1 AND 10 ORDER BY Y_COORDINATE DESC, X_COORDINATE")
