...
COMMENT ON COLUMN MD_STOCKYARD.YARD_TYPE IS 'Typ: I=Internal, E=External, S=Saw, A=SwapOut/Ausgang, N=SwapIn/Eingang, L=Loading';
...
CREATE TABLE MD_INGOTTYPE (
    ...
    SAW_TO_SWAPOUT  NUMBER(1) DEFAULT 0,
...
COMMENT ON COLUMN MD_INGOTTYPE.SAW_TO_SWAPOUT IS 'Automatisch von Saege zum Ausgang (1=Ja)';
...
CREATE TABLE TD_CALLOFF (
    ...
    SERIAL              NUMBER(19) DEFAULT 1 NOT NULL,
    TABLESERIAL         NUMBER(19) DEFAULT 1 NOT NULL,
    CALLOFF_NUMBER      VARCHAR2(50) NOT NULL,
...
COMMENT ON COLUMN TD_CALLOFF.CALLOFF_NUMBER IS 'Abrufnummer (eindeutig)';
...
CREATE INDEX IDX_CALLOFF_PRODUCT ON TD_CALLOFF(PRODUCT_ID);
...
VALUES (1, 1, 'KURZ', 'normale kurze Barren', 'S', 1, 1, 1, 0, 3500, 4299, 0);

INSERT INTO MD_INGOTTYPE (ID, SERIAL, NAME, DESCRIPTION, LENGTH_TYPE, INTERNAL_ALLOWED, EXTERNAL_ALLOWED, RETRIEVAL_ALLOWED, AUTO_RETRIEVAL, MIN_LENGTH, MAX_LENGTH, PRIORITY)
VALUES (2, 1, 'LANG', 'normale lange Barren', 'L', 1, 1, 0, 0, 7500, 8700, 0);

INSERT INTO MD_INGOTTYPE (ID, SERIAL, NAME, DESCRIPTION, LENGTH_TYPE, INTERNAL_ALLOWED, EXTERNAL_ALLOWED, RETRIEVAL_ALLOWED, AUTO_RETRIEVAL, SAW_TO_SWAPOUT, MIN_LENGTH, MAX_LENGTH, MAX_WEIGHT, PRIORITY)
VALUES (3, 1, 'MITTEL', 'mittellange Barren', 'M', 0, 1, 1, 1, 1, 4300, 7400, 18000, 0);
